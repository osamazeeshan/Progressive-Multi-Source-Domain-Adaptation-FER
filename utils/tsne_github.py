...
def tsne_guthub_main(combine_srcs_loader):
    # set seed
    ...
    targets, outputs = gen_features(net, combine_srcs_loader)
...
def tsne_plot(save_dir, targets, outputs):
    ...
    # plt.scatter(current_tx, current_ty, label=labels[label])
